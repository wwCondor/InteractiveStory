...
// after 'return'  below add # imageLiteral(resourceName: "ReturnTrip")
// this is another solution to adding an image literal

// another way to do this is to type 'image Literal', it should autocomplete
// then click the image and select the appropriate image
...
extension Story {
    var artwork: UIImage {
        ...
        case .homeward: return #imageLiteral(resourceName: "Homeward")// Homeward
        case .rover: return #imageLiteral(resourceName: "Rover") // Rover
        ...
        case .home: return #imageLiteral(resourceName: "Home") // Home
        }
    }
    ...
    var text: String {
        ...
        case .homeward:
            return "You continue your course to Earth. Two days later, you receive a transmission from HQ saying that they have detected some sort of anomaly on the surface of Mars near an abandoned rover. They ask you to investigate, but ultimately the decision is yours because your mission has already run much longer than planned and supplies are low."
        case .rover(let name):
