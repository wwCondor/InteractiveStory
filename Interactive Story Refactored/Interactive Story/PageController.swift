...
//  Interactive Story
//
//  Created by Wouter Willebrands on 19/01/2019.
...
extension Story {
    var attributedText: NSAttributedString {
        ...
        paragrapghStyle.lineSpacing = 10
        
        attributedString.addAttribute(NSAttributedString.Key.paragraphStyle, value: paragrapghStyle, range: attributedString.stringRange)
...
class PageController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad() // sets op base view controller
    ...
    override func viewWillLayoutSubviews() {
        ...
        // this connects each anchor of artwork view
        // to its relevant anchor of parent view
        ...
        // code below adds first and second choice button
        // along with apropriate constraints
